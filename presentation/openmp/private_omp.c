...
double ScaleX[2] = {-2.5, 1.5};
double ScaleY[2] = {-2.0, 2.0};

double Radius = Bailout * Bailout;
...
int main() {
    ...
    #pragma omp parallel for private(ImageHeight, ImageWidth, PixelWidth, PixelHeight, ScaleX, ScaleY, Radius)
